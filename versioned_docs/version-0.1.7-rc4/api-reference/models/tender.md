...
sidebar_position: 4
title: Tender
description: Tender models used by the CorePOS Android SDK.
hide_title: true
---
...
**Optional:**
- `Intents.EXTRA_TENDER_TYPE`(TenderType, enum) — Specify a concrete [`TenderType`](tender.md#tendertype) (e.g., EBT). 
